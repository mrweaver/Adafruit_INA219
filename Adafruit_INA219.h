...
enum
{
    INA219_CONFIG_ADCRES_9BIT_1S = (84),
    INA219_CONFIG_ADCRES_10BIT_1S = (148),
    INA219_CONFIG_ADCRES_11BIT_1S = (276),
    INA219_CONFIG_ADCRES_12BIT_1S = (532),
    INA219_CONFIG_ADCRES_12BIT_2S = (1060),
    INA219_CONFIG_ADCRES_12BIT_4S = (2130),
    INA219_CONFIG_ADCRES_12BIT_8S = (4260),
    INA219_CONFIG_ADCRES_12BIT_16S = (8510),
    INA219_CONFIG_ADCRES_12BIT_32S = (17020),
    INA219_CONFIG_ADCRES_12BIT_64S = (34050),
    INA219_CONFIG_ADCRES_12BIT_128S = (69100)
};
...
/** these bits are to be read from Bus Voltage register */
enum
{
    INA219_OVF_MASK = 0x0001,  // bit 0 - Math Overflow Flag
    INA219_CNVR_MASK = 0x0002, // bit 1 - Conversion Ready
};
